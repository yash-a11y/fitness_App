...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final FrameLayout bmily;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.bmily;
      FrameLayout bmily = ViewBindings.findChildViewById(rootView, id);
      if (bmily == null) {
        break missingId;
      }

      id = R.id.flyout;
      FrameLayout flyout = ViewBindings.findChildViewById(rootView, id);
      if (flyout == null) {
        break missingId;
      }
